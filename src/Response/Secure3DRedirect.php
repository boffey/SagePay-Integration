...
class Secure3DRedirect extends AbstractTransaction
{
    ...
    public function getPaRequestFields($termUrl = null, $md = null)
    {
        ...
        return $this->getCReqRequestFields($termUrl, $md);
    }

    public function getCReqRequestFields($termUrl = null, $md = null)
    {
        $fields = [
            'creq' => $this->getCReq(),
        ];
        ...
        if (isset($termUrl)) {
            $fields['threeDSNotificationURL'] = $termUrl;
        }

        if (isset($md)) {
            $fields['threeDSSessionData'] = base64_encode($md);
        }
